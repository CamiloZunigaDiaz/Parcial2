<%-- 
    Document   : Login
    Created on : 2/12/2020, 01:12:23 PM
    Author     : camil
--%>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" name="chkRecordar"> Recordar Contraseaña</label>
                            </div>
                        </div>
                        <input type="submit" class="btn btn-primary btn block" name="btnLogin" value="Aceptar"/>
                    </form>
